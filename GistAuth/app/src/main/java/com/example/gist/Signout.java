            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()){
                    ...
                    case R.id.nav_Gallery:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new fragment_Gallery()).commit();
                        break;
                    case R.id.nav_civil:
                    ...
                    case R.id.nav_placements:
                        ...
                        break;
                    case R.id.nav_nss:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,new fragment_Nss()).commit();
                        break;
